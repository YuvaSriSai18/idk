...
- **📧 Email Notifications**: Automated job alert emails sent every 6 hours via SendGrid
...
- **🔐 Cron Automation**: GitHub Actions scheduled cron job runs every 6 hours
...
4. **Cron Job Runs** (every 6 hours) → Fetches YouTube videos
